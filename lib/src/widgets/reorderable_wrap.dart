...
class _ReorderableWrapContentState extends State<_ReorderableWrapContent> with TickerProviderStateMixin<_ReorderableWrapContent>, ReorderableMixin {
...
//            }
      ...
      Widget nextDragTarget = DragTarget<int>(
        builder: (BuildContext context, List<int?> acceptedCandidates, List<dynamic> rejectedCandidates) => SizedBox(),
        onWillAcceptWithDetails: (details) => _onWillAccept(details.data, false),
        onLeave: (Object? leaving) {},
      );
